''' Taken from https://github.com/dysonance/Trendy , great repository'''

import pandas as pd
from numba import jit, cuda

def gentrends(x, window=1/3.0, charts=True): # Computes support/resistance
    """
...
def segtrends(x, segments=2, charts=True):
    ...
    # OUTPUT
    return x_maxima, maxima, x_minima, minima, maxline, minline
